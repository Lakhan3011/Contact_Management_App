...
const Contacts = () => {
  ...
  return (
    <div className="justify-center pt-16 text-white   p-4  w-full ">
      <div className="m-8">
        <button className="rounded-full p-3 text-xl transition ease-in-out delay-150 bg-gray-500 hover:-translate-y-1 hover:scale-110 hover:bg-gray-700 duration-300 ...">
      ...
      >
        {AllContacts.map((el) => {
          return (
            <div
              key={el.id}
              className="bg-gray-600 rounded-lg shadow-md m-4 p-4 text-gray-50"
            >
